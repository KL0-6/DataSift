    ...
    <Router>
      <motion.div className="flex flex-col min-h-screen bg-white" initial="hidden" animate="visible" variants={staggerContainer}>
          ...
          <Route path="/" element={
            <>
              <section className="text-center py-24 px-6 bg-white mt-16">
                ...
                <motion.p className="mt-6 text-lg md:text-xl text-gray-700 max-w-xl mx-auto" variants={fadeInUp} transition={{ duration: 0.3 }}>
              ...
              <section className="py-20 bg-gray-50">
                <div className="max-w-6xl mx-auto px-6">
                  <motion.h2 className="text-3xl md:text-4xl font-bold text-center mb-12" variants={fadeInUp} transition={{ duration: 0.3 }}>
                    Features We're Working On
                  </motion.h2>
                  <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-12" variants={staggerContainer}>
                    {features.map((feature, index) => (
                      <motion.div key={index} className={`p-8 rounded-lg shadow-lg flex flex-col items-center text-center ${feature.bgColor} hover:shadow-xl transition-shadow duration-300`} variants={fadeInUp} whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
                        <div className="mb-4">
                          {feature.icon}
                        </div>
              ...
              <section className="py-20 bg-white">
                <div className="max-w-6xl mx-auto px-6 text-center">
                  <motion.h2 className="text-3xl md:text-4xl font-bold mb-12" variants={fadeInUp} transition={{ duration: 0.3 }}>
                    What's Next for DataSift?
                  </motion.h2>
                  <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-12" variants={staggerContainer}>
                    {nextSteps.map((step, index) => (
                      <motion.div key={index} className={`p-8 rounded-lg shadow-lg flex flex-col items-center text-center ${step.bgColor} hover:shadow-xl transition-shadow duration-300`} variants={fadeInUp} whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
                        <div className="mb-4">
                          {step.icon}
                        </div>
              ...
              <section className="py-20 bg-white">
                <div className="max-w-6xl mx-auto px-6">
                  ...
                  <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-12" variants={staggerContainer}>
                    {testimonials.map((testimonial, index) => (
                      <motion.div key={index} className="bg-gray-50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300" variants={fadeInUp} whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
        ...
        <footer className="bg-primary text-white py-8">
          <div className="max-w-6xl mx-auto px-6 text-center">
            <motion.p variants={fadeInUp} transition={{ duration: 0.3 }}>
              &copy; {new Date().getFullYear()} DataSift. All rights reserved.
            </motion.p>
            <motion.div className="mt-4" variants={fadeInUp} transition={{ duration: 0.3 }}>
